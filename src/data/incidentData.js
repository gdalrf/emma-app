...
export const INCIDENTS = [
  {
    ...
    reading: 164,
    unit: 'µg/m³',
    vessel: { id: 'V02', name: 'PS Ferry', type: 'Ferry', engineType: 'Heavy Marine Diesel', imo: '9234567' },
    windDir: 230,
    windSpeed: 15,
    confidence: 88,
    severity: 'high',
    title: 'Unusual NO2 spike — Millbay Ferry Terminal',
    description: 'NO₂ reading of 164 µg/m³ detected during Ferry departure procedure at 08:10. SW wind at 15 kn is consistent with direct plume transport from Berth 5 to sensor S02. AIS data confirms vessel at berth 08:02–08:17.',
  },
  {
    id: 'INC-002',
    date: '2025-01-14',
